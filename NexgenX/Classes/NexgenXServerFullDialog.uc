 ...
 *
 *  $CLASS        NexgenXServerFullDialog
 *  $VERSION      1.00 (8-3-2008 15:57)
 *  $AUTHOR       Daan 'Defrost' Scheerens  initial version
 *  $CONTACT      d.scheerens@gmail.com
 *  $DESCRIPTION  Dialog to display if the server is full. 
 *
 **************************************************************************************************/
class NexgenXServerFullDialog extends NexgenPopupDialog;
 ...
 *
 **************************************************************************************************/
function setContent(optional string message, optional string server1, optional string server2, optional string server3) {
	local float cy;
