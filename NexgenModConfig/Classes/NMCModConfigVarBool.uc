 ...
 *
 *  $CLASS        NMCModConfigVarBool
 *  $VERSION      1.01 (13-02-2010 23:44)
 *  $AUTHOR       Daan 'Defrost' Scheerens  initial version
 *  $CONTACT      d.scheerens@gmail.com
 *  $DESCRIPTION  Definition class for boolean mod configuration variables.
 *
 **************************************************************************************************/
class NMCModConfigVarBool extends NMCModConfigVar;
...
function byte getDataType() {
	return modConfig.cfgContainer.DT_BOOL;
}
...
function byte getDefaultInputType() {
	return modConfig.cfgContainer.IT_CHECKBOX;
}